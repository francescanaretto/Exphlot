'''This script contains the functions for training and testing the Rocket model.
Rocket is a fast classifer for time series, which uses convolutional kernels, initialized randomly.
REQUIREMENTS: The functions here use numba to parallelize the computations.
'''
